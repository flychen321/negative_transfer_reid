...
parser.add_argument('--dataset', default='duke', type=str, help='the name of dataset')
...
download_path = 'data/' + opt.dataset

if 'cuhk' in download_path:
    suffix = 'png'
elif 'viper' in download_path:
    suffix = 'bmp'
elif 'prid' in download_path:
    suffix = 'png'
else:
    suffix = 'jpg'
